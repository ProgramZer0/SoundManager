...
```json
   "com.caleb.soundsystem": "file:../../SoundSystem"
   ```
...
```json
   "com.ProgramZer0.soundsystem": "https://github.com/yourname/soundsystem.git"
   ```
...
game's code.
* Both classes are wrapped in the `Caleb.SoundSystem` namespace so they won't
